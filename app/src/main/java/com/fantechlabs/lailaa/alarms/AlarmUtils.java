...
import static com.fantechlabs.lailaa.alarms.DatabaseHelper.COL_FIRED;
import static com.fantechlabs.lailaa.alarms.DatabaseHelper.COL_FRI;
import static com.fantechlabs.lailaa.alarms.DatabaseHelper.COL_INTAKE;
import static com.fantechlabs.lailaa.alarms.DatabaseHelper.COL_IS_ENABLED;
import static com.fantechlabs.lailaa.alarms.DatabaseHelper.COL_LABEL;
import static com.fantechlabs.lailaa.alarms.DatabaseHelper.COL_MON;
import static com.fantechlabs.lailaa.alarms.DatabaseHelper.COL_SAT;
import static com.fantechlabs.lailaa.alarms.DatabaseHelper.COL_SUN;
import static com.fantechlabs.lailaa.alarms.DatabaseHelper.COL_THURS;
import static com.fantechlabs.lailaa.alarms.DatabaseHelper.COL_TIME;
import static com.fantechlabs.lailaa.alarms.DatabaseHelper.COL_TUES;
import static com.fantechlabs.lailaa.alarms.DatabaseHelper.COL_WED;
import static com.fantechlabs.lailaa.alarms.DatabaseHelper._ID;
...
public final class AlarmUtils
{
    ...
    public static boolean checkAlarmPermissions(Activity activity)
    {
    ...
    public static ContentValues toContentValues(Alarm alarm)
    {
        ...
        cv.put(COL_INTAKE, alarm.isMedicineIntake() ? 1 : 0);
        cv.put(COL_INTAKE, alarm.isAlarmFire() ? 1 : 0);
        ...
        cv.put(COL_INTAKE, alarm.isMedicineIntake());
        cv.put(COL_FIRED, alarm.isAlarmFire());
    ...
    public static ArrayList<Alarm> buildAlarmList(Cursor c)
    {
        ...
        if (c.moveToFirst())
        {
            do
            {
                ...
                final boolean isIntake = c.getInt(c.getColumnIndex(COL_INTAKE)) == 1;
                final boolean isFired = c.getInt(c.getColumnIndex(COL_FIRED)) == 1;
                ...
                alarm.setAlarmFire(isFired);
                alarm.setMedicineIntake(isIntake);

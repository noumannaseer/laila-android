...
//*********************************************************
{
    ...
    //*********************************************************
    public static com.fantechlabs.lailaa.utils.LocationUtils getInstance(Activity activity)
    //*********************************************************
    {
        return new com.fantechlabs.lailaa.utils.LocationUtils(activity);

    }

    //*********************************************************
    public static com.fantechlabs.lailaa.utils.LocationUtils getInstance(Context context)
    //*********************************************************
    {
        return new com.fantechlabs.lailaa.utils.LocationUtils(context);
    }

    //**************************************************************************************
    public com.fantechlabs.lailaa.utils.LocationUtils getCurrentLocation(boolean isLocationUpdate, int minTime,
                                                                         int minDistance,
